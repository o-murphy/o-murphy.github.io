...
fetch(baseUrl, {
    ...
    .then((txt) => {
        ...
        fs.writeFile('./public/data/pull_requests.json', JSON.stringify(cropped, null, 2), function (err) {
            if (err) {
                console.log(err);
            }
        });
...
fetch(baseUrl, {
    ...
    .then((txt) => {
        ...
        fs.writeFile('./public/data/issues.json', JSON.stringify(cropped, null, 2), function (err) {
            if (err) {
...
fetch(baseUrl, {
    ...
    .then((txt) => {
        ...
        fs.writeFile('./public/data/organizations.json', JSON.stringify(newOrgs, null, 2), function (err) {
            if (err) {
                console.log(err);
            }
        });
...
fetch(baseUrl, {
    ...
    .then((txt) => {
        ...
        fs.writeFile('./public/data/projects.json', JSON.stringify(newProjects, null, 2), function (err) {
            if (err) {
