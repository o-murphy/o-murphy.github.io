                ...
                <section id="about-content" className="flex flex-col md:flex-row items-center justify-center md:justify-between h-full text-center md:text-left">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <a href="https://github.com/o-murphy/py-ballisticcalc" className="block p-1 text-black hover:bg-black hover:text-white">
                                <div className="flex justify-between items-center mb-2">
                                    <h3 className="font-bold text-base leading-snug">py-ballisticcalc</h3>
                                    <div>
                                        <FontAwesomeIcon icon={faPython} className="text-xl" />
                                        <FontAwesomeIcon icon={faC} className="text-xl" />
                                    </div>
                                </div>
                                <p className="text-xs">
                            ...
                            {/* Project 2: pydfuutil */}
                            <a href="https://github.com/o-murphy/pydfuutil" className="block p-1 text-black hover:bg-black hover:text-white">
                                <div className="flex justify-between items-center mb-2">
                            ...
                            <a href="https://github.com/o-murphy/js-ballistics" className="block p-1 text-black hover:bg-black hover:text-white">
                                <div className="flex justify-between items-center mb-2">
                            ...
                            <a href="https://github.com/o-murphy/py-aiowialon" className="block p-1 text-black hover:bg-black hover:text-white">
                                <div className="flex justify-between items-center mb-2">
                                    <h3 className="font-bold text-base leading-snug">py-aiowialon</h3>
                                    <FontAwesomeIcon icon={faPython} className="text-xl text-black-500 dark:text-black-400" />
                                </div>
                                <p className="text-xs">
