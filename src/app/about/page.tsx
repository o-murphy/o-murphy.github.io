                ...
                <section id="about-content" className="flex flex-col md:flex-row items-center justify-center md:justify-between h-full text-center md:text-left">
                    ...
                    <div className="md:w-1/2 mb-8 md:mb-0 md:pl-4">
                        <p className="text-sm font-light leading-relaxed">
                            ...
                            <a href="https://github.com/o-murphy/py-ballisticcalc" className="underline hover:bg-black hover:text-white p-1">
                            ...
                            <a href="https://github.com/o-murphy/pydfuutil" className="underline hover:bg-black hover:text-white p-1">
                                pydfuutil
                            </a>
                            `, a pure Python wrapper for `dfu-util`, and `
                            <a href="https://github.com/o-murphy/a7p" className="underline hover:bg-black hover:text-white p-1">
                                a7p
                            </a>
