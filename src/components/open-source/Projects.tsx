...
import { faCode, faDatabase, faGem, faTerminal, faFileCode } from '@fortawesome/free-solid-svg-icons';
...
type LanguageIcon = { kind: 'fa'; icon: IconDefinition } | { kind: 'si'; Icon: SiIconComponent };
