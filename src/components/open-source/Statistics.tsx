    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div onClick={() => scrollToId('pull-requests')} className="cursor-pointer">
                <div className="bg-green-100 dark:bg-green-500/15 p-4 rounded-lg hover:bg-green-200 dark:hover:bg-green-500/25 transition-colors">
            ...
            <div onClick={() => scrollToId('pull-requests')} className="cursor-pointer">
                <div className="bg-purple-100 dark:bg-purple-500/15 p-4 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-500/25 transition-colors">
            ...
            <div onClick={() => scrollToId('issues')} className="cursor-pointer">
                <div className="bg-blue-100 dark:bg-blue-500/15 p-4 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-500/25 transition-colors">
                    <div className="flex items-center justify-center gap-2">
